...
public class TextFlowAppDavidTestarVidare extends JPanel{
	...
	public static void main(String[] args) throws Exception{
		...
		//The display will be as wide as the length of the string
		ColorDisplay d = new ColorDisplay(1,txt.length(),Color.RED, Color.CYAN);
		...
		timer.schedule(new TimerTask() { // Here starts the class
	            ...
	            public void run() {
	            	...
	            	if(counter < txt.length()){
	                	...
	                	d.setDisplay(txtArrays[counter].getArray(), 0,counter);
	                	d.updateDisplay();
