...
public class ColorDisplay extends JComponent {
	...
	public static void main(String[] args) {
		int[][] arr = {{Color.RED,	Color.RED,	Color.RED,	Color.RED,	Color.RED,	Color.RED,	Color.RED},
						{Color.RED,	Color.RED,	Color.BLACK,Color.RED,	Color.BLACK,Color.RED,	Color.RED},
						{Color.RED,	Color.RED,	Color.RED,	Color.LTGRAY,	Color.RED,	Color.RED,	Color.RED},
						{Color.RED,	Color.BLACK,Color.RED,	Color.RED,	Color.RED,	Color.BLACK,Color.RED},
						{Color.RED,	Color.RED,	Color.BLACK,Color.BLACK,Color.BLACK,Color.RED,	Color.RED},
		...
		JOptionPane.showMessageDialog(null, new ColorDisplay(Color.YELLOW,Color.BLUE));
	}
}
